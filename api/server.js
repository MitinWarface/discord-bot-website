    ...
    try {
        ...
        if (settings.leveling) {
            ...
            if (typeof settings.leveling.xpPerMessageMax === 'number') {
                processedSettings.leveling.xpPerMessageMax = Math.max(1, Math.min(10, settings.leveling.xpPerMessageMax));
            }
        ...
        if (settings.economy) {
            ...
            if (typeof settings.economy.dailyAmount === 'number') {
                processedSettings.economy.dailyAmount = Math.max(1, Math.min(100, settings.economy.dailyAmount));
            }
            ...
            switch (interaction.customId) {
                ...
                case 'aurora_help':
                    const helpEmbed = new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: '`/ban`', value: 'Заблокировать пользователя на сервере (<@&139365865908211814>, <@&1399359075657056428>)', inline: false },
                ...
                case 'aurora_daily':
                    ...
                    if (canClaimDaily(interaction.user.id)) {
                        ...
                        const minutes = Math.floor((timeUntilNext % (10 * 60)) / (1000 * 60));
