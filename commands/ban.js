...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addUserOption(option =>
            option.setName('user')
                .setDescription('Пользователь, которого хотите заблокировать')
                .setRequired(true))
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`<@${moderator.id}> заблокировал(а) пользователя <@${targetUser.id}>`)
                .addFields(
            ...
            await interaction.reply({ 
                content: 'Произошла ошибка при попытке заблокировать пользователя.', 
                ephemeral: true 
            });
        }
    }
